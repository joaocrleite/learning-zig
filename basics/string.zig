...
pub fn main() !void {
    ...
    const w: [7]u8 = [7]u8{ a, b, c, d, 'e', 102, '!' };
    const wl = w.len;
...
// const w type:[7]u8 len:7 ascii:{ 97, 66, 67, 100, 101, 102, 33 } word:aBCdef!
// const w_up type:[7]u8 len:7 ascii:{ 65, 66, 67, 68, 69, 70, 33 } word:ABCDEF!
// const w_low type:[7]u8 len:7 ascii:{ 97, 98, 99, 100, 101, 102, 33 } word:abcdef!
